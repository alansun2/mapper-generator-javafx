...
import com.alan344.utils.SpringHelper;
...
public class ObjectFactory {
    ...
    private static final MybatisPluginService mybatisPluginService;

    static {
        externalClassLoaders = new ArrayList<>();
        mybatisPluginService = SpringHelper.getBean(MybatisPluginService.class);
    }
    ...
    public static Class<?> internalClassForName(String type)
        ...
        if (clazz == null) {
            final MybatisPluginConfig byClassName = mybatisPluginService.getByClassName(type);
            return byClassName.getClazz();
        }
