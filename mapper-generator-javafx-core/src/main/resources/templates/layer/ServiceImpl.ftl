...
public class ${TYPE_NAME_UPPER_CAMEL}ServiceImpl implements ${TYPE_NAME_UPPER_CAMEL}ServiceI {
    ...
    private ${TYPE_NAME_UPPER_CAMEL} convert(${TYPE_NAME_UPPER_CAMEL}Cmd cmd) {
        <@ic.ignoreColumnCheck "${TYPE_NAME_UPPER_CAMEL}" "${TYPE_NAME_LOWER_CAMEL}" "cmd" "null" "Cmd" FIELDS_UPPER_CAMELS IGNORE_FIELDS_MAP true !/>
    ...
    private ${TYPE_NAME_UPPER_CAMEL}DTO convertToDTO(${TYPE_NAME_UPPER_CAMEL} ${TYPE_NAME_LOWER_CAMEL}) {
        <@ic.ignoreColumnCheck "${TYPE_NAME_UPPER_CAMEL}DTO" "${TYPE_NAME_LOWER_CAMEL}DTO" "${TYPE_NAME_LOWER_CAMEL}" "DTO" "DO" FIELDS_UPPER_CAMELS IGNORE_FIELDS_MAP true !/>
